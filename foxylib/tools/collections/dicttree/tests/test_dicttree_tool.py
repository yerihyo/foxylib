                            ...
                            'matches': [{'ends_at': datetime.datetime(2021, 1,
                                        ...
                                        {'ends_at': datetime.datetime(2021, 1,
                                         ...
                                         'starts_at': datetime.datetime(2021, 1,
                                                                        ...
                                                                        958000,
                                                                        tzinfo=pytz.utc),
                                         'stats': [{'choice_key': 'shinhwa',
                                                    'score': Decimal('0')},
                                                   {'choice_key': 'highlight',
                                                    'score': Decimal('0')}],
                                         'title': 'round of 32'},
                                        {'ends_at': datetime.datetime(2021, 1,
                                                                      9, 1, 33,
